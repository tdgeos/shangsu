...
<li><a href="../tour.php?i=6">当地特色</a></li> 
 ...
 <li class="frest"><a href="../helper.php" class="active">生活助手</a>
<ul>
<li><a href="everday.php">日常生活</a></li>
<li><a href="recreation.php">休闲娱乐</a></li>
<li><a href="luck.php">星座运程</a></li> 
<li><a href="net.php">上网工具</a></li>
<li><a href="shop.php">购物理财</a></li> 
<li><a href="study.php">在线学习</a></li>
</ul>
</li>
<li><a href="../forum/upload"target="_blank">尚素论坛</a></li>
...
<li><a href="../phone.php">手机客户端</a></li>
        ...
        <nav2> 
        	<ul> 
					  	<li><a href="everday.php">日 常 生 活</a></li>
						<li><a href="recreation.php">休 闲 娱 乐</a></li>
						<li><a href="luck.php">星 座 运 程</a></li>
						<li><a href="net.php">上 网 工 具</a></li>
					  	<li><a href="shop.php">购 物 理 财</a></li>
					  	<li><a href="study.php">在 线 学 习</a></li>
           </ul>
       </nav2>
       						</div>
                         </div>
...
<!--脚本-->
  ...
  <script type="text/javascript" src="../js/deleteadd.js"></script>

  <script type="text/javascript" src="../js/helper_tool.js"></script>

   <script type="text/javascript">

  (function(){var c=document.body.getAttribute("toolkit_id"),e=OALLTOOLKITSET[c],a=document.createDocumentFragment();if(e){for(var d in e){CREATETOOL(e[d],c,d,a,"add")}var b=T.g(c);if(b){b.appendChild(a)}}indexSetHome.bind("set-home")})();  
