...
<li class="frest"><a href="message.php?i=0" class="active">资讯</a>
<ul>
...
<h6><div class="container_message"></div></h6> 
<div class="subContainerpading clearfix"> 
<div class="d_avatar avatar48">
<div class="slide">
<nav2> 
<ul> 
<li><a href="message.php?i=1">尚 素 资 讯</a></li>
<li><a href="message.php?i=2">名 人 动 向</a></li>
<li><a href="message.php?i=3">素 食 餐 馆</a></li>
<li><a href="message.php?i=4">素 食 百 科</a></li>
<li><a href="message.php?i=5">食 素 误 区</a></li>
<li><a href="message.php?i=6">线 下 活 动</a></li>
</ul>
</nav2>
</div>
</div>
...
case 0:
?>
<h3><div class="container_mes_mes"><a2>
<a href="message.php?i=1">更多</a></a2></div></h3>
...
<h3><div class="container_mes_trend">
<a href="message.php?i=2">更多</a></div></h3> 
<div class="subContainer eheight2 subContainerpading clearfix">
<div class="d_avatar avatar48">
</div>
<table border="0" width="800" cellspacing="1" align="left">
...
<h3>
<div class="container_mes_eatery"><a2>
<a href="message.php?i=3">更多</a></a2></div></h3> 
<div class="subContainer eheight2 subContainerpading clearfix">
<div class="d_avatar avatar48">
</div>
<table border="0" width="800" cellspacing="1" align="left">
...
<h3>
<div class="container_mes_learn">
<a href="message.php?i=4">更多</a></div></h3> 
<div class="subContainer eheight2 subContainerpading clearfix">
<div class="d_avatar avatar48">
</div>
<table border="0" width="800" cellspacing="1" align="left">
...
<h3>
<div class="container_mes_error"><a2>
<a href="message.php?i=5">更多</a></a2></div></h3> 
<div class="subContainer eheight2 subContainerpading clearfix">
<div class="d_avatar avatar48">
</div>
<table border="0" width="800" cellspacing="1" align="left">
<?php mysql_select_db('bbs');
$sql = "SELECT `subject`, `author`,`authorid`, `fid` ,`tid`FROM `ss_forum_thread` order by tid desc";
$result = mysql_query($sql) or die("查询失败!");
/* 在 HTML 中打印结果 */
$number = 6;
...
<h3>
<div class="container_mes_activity">
<a href="message.php?i=6">更多</a></div></h3> 
<div class="subContainer eheight2 subContainerpading clearfix">
<div class="d_avatar avatar48"></div>
<table border="0" width="800" cellspacing="1" align="left">
<?php
$sql = "SELECT `subject`, `author`,`authorid`, `fid` ,`tid`FROM `ss_forum_thread` order by tid desc";
$result = mysql_query($sql) or die("查询失败!");
...
case 1:
?>
<h3><div class="container_mes_mes"></div></h3>
<div class="subContainer eheight2 subContainerpading clearfix"> 
<div id="previewArea" class="previewArea"></div>
<div class="d_avatar avatar48">
</div>
...
<h3><div class="container_mes_trend2"></div></h3>
<div class="subContainer eheight2 subContainerpading clearfix"> 
<div id="previewArea" class="previewArea"></div>
<div class="d_avatar avatar48">
</div>
...
case 3:
?>
<h3><div class="container_mes_eatery"></div></h3>
 <div class="subContainer eheight2 subContainerpading clearfix"> 
 <div id="previewArea" class="previewArea"></div>
<div class="d_avatar avatar48">
</div>
...
case 4:
?>
<h3><div class="container_mes_learn2"></div></h3>
<div class="subContainer eheight2 subContainerpading clearfix"> 
<div id="previewArea" class="previewArea"></div>
<div class="d_avatar avatar48">
</div>
...
case 5:
?>
<h3><div class="container_mes_error"></div></h3>
<div class="subContainer eheight2 subContainerpading clearfix"> 
<div id="previewArea" class="previewArea"></div>
<div class="d_avatar avatar48">
</div>
...
case 6:
?>
<h3><div class="container_mes_activity2"></div></h3>
<div class="subContainer eheight2 subContainerpading clearfix"> 
<div id="previewArea" class="previewArea"></div>
<div class="d_avatar avatar48">
</div>
