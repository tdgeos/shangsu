...
define('UC_DBNAME', 'shangsu'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`shangsu`.ss_ucenter_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'Gcu03ai7Kf88m0tb2bY167n1f9h8SbA5udnfLbh8D7Xbx1rdHau6m9ScT078Udm1'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://127.0.0.1/shang4.0/forum/upload/uc_server'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
