<?php
	...
	define( 'IN_SKY', true );
	define( 'SKY_INSTALL_ROOT', dirname( __FILE__ ) );
	define( 'SKY_ROOT', substr( dirname( __FILE__  ), 0, -8 ) );
	
	require_once SKY_INSTALL_ROOT.'/vo/view.class.php';
	$viewObject = new Vo_View_Class();
	$viewObject->version = $version;
	
	require_once SKY_INSTALL_ROOT.'/common/global.class.php';
